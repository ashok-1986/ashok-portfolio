...
export default function Experience() {
  ...
  return (
    <section id="experience" className="relative py-[160px] md:py-[200px] px-[30px] md:px-[60px] bg-[#190805]">
      <div className="max-w-[1200px] mx-auto">
        ...
        <h2 className="sec-title rev text-[clamp(52px,7.5vw,110px)] font-semibold text-[#F0F3F5] mb-[72px] leading-[0.9]">
          Experience
        </h2>
        ...
        <div className="timeline max-w-[840px] w-full mt-16 relative">
          ...
          {EXPERIENCE.map((item, index) => (
            <div
              key={index}
              className={`t-item rev pl-10 md:pl-12 mb-16 relative transition-all duration-1000 ${index % 2 === 0 ? 'd1' : 'd2'}`}
            ...
            >
              ...
              <div className="t-co text-[13px] font-medium text-[rgba(240,243,245,0.6)] tracking-[0.06em] mb-4 uppercase">
                {item.company}
              </div>
              <p className="t-desc text-[14px] font-light leading-[1.78] text-[rgba(240,243,245,0.5)]">
                {item.desc}
              </p>
              {item.metric && (
