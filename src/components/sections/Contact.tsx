...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative py-[160px] md:py-[200px] px-[30px] md:px-[60px] bg-[#190805] min-h-[80vh] overflow-hidden">
      {/* Background Glow */}
      ...
      <div className="max-w-[1200px] mx-auto relative z-10">
        <div className="contact-grid grid grid-cols-1 md:grid-cols-2 gap-[60px] md:gap-[120px] items-start">
          <div className="rev d1">
            <h2 className="contact-cta text-[clamp(44px,6.5vw,84px)] font-semibold text-[#F0F3F5] mb-9 leading-[0.95]">
              Let&apos;s Build <br />
              <span className="text-[#FC4F2F]">Clarity</span>
            </h2>
          ...
          <form className="cf rev d2 flex flex-col gap-8 w-full max-w-[500px]">
            ...
            <button type="submit" className="nav-cta relative inline-block text-[10.5px] font-semibold tracking-[0.18em] uppercase text-[#190805] bg-[#FC4F2F] px-[32px] py-[14px] no-underline transition-opacity hover:opacity-80 self-start border-none cursor-pointer">
              Send Message
            </button>
          </form>
        </div>
