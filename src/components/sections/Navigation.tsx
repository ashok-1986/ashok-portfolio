...
export default function Navigation() {
  return (
    <nav className="fixed top-0 left-0 right-0 z-[500] px-[30px] md:px-[60px] py-[20px] md:py-[26px] flex justify-between items-center bg-gradient-to-b from-[rgba(25,8,5,0.95)] to-transparent">
      <a href="/" className="nav-logo relative font-semibold tracking-[0.28em] uppercase text-[#F0F3F5] transition-opacity hover:opacity-80">
        Ashok <em>Verma</em>
      </a>
      ...
      <a
        ...
        className="nav-cta relative inline-block text-[9px] md:text-[10.5px] font-semibold tracking-[0.18em] uppercase text-[#190805] bg-[#FC4F2F] px-[18px] md:px-[26px] py-[9px] md:py-[11px] no-underline transition-opacity hover:opacity-80"
      >
        Let's Talk
      </a>
    </nav>
