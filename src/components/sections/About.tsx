...
export default function About() {
  ...
  return (
    <section id="about" className="relative py-[160px] md:py-[200px] px-[30px] md:px-[60px] bg-[#190805]">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="about-grid grid grid-cols-1 md:grid-cols-2 gap-[60px] md:gap-[100px] w-full items-start">
          <div className="rev d1">
            <h2 className="about-statement text-[clamp(40px,5.5vw,72px)] font-semibold text-[#F0F3F5] leading-[0.9] mb-11">
              Not A<br />
          ...
          <div className="about-body rev d2">
        ...
        <div className="stat-strip flex flex-col md:flex-row gap-0 border-t border-[rgba(240,243,245,0.07)] mt-14 pt-12 w-full">
          {STATS.map((stat, index) => (
            <div key={stat.label} className={`stat-item flex-1 md:pr-10 md:border-r border-[rgba(240,243,245,0.07)] md:mr-10 mb-8 md:mb-0 ${index === STATS.length - 1 ? 'border-r-0 mr-0 pr-0' : ''} rev ${index === 0 ? 'd1' : index === 1 ? 'd2' : 'd3'}`}>
